import { Bell, Menu, Zap, Home } from 'lucide-react';
    ...
    <header className="sticky top-0 z-30 bg-white border-b-4 border-dark-500">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleLogoClick}
            className="p-2.5 hover:bg-accent-500 transition-all border-2 border-dark-500 hover:shadow-brutal-sm active:shadow-none active:translate-x-1 active:translate-y-1"
            title="Go to Homepage"
          >
            <Home size={20} className="text-dark-500" strokeWidth={2.5} />
          </button>
